...
export default function ReferralSearchBar({ value, onChange, onHistoryClick }: Props) {
  ...
  return (
    <div className="flex min-w-0 w-full flex-row items-center justify-between gap-2 md:gap-3">
      ...
      <Link href="/trade-to-earn/history" className="shrink-0">
        <Button
          variant={ButtonVariant.CONTAINED}
          colorScheme={ButtonColor.LIGHT_GREEN}
          size={ButtonSize.MEDIUM}
          mobileSize={ButtonSize.SMALL}
          className="min-w-[68px] px-2.5 md:min-w-[88px] md:px-4"
        >
          {t("history")}
        </Button>
      </Link>
