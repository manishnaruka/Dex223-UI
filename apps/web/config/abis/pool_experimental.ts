export const EXPERIMENTAL_POOL_ABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bool", name: "token0_223", type: "bool" },
      { internalType: "bool", name: "token1_223", type: "bool" },
    ],
    name: "collect",
    outputs: [
  ...
  },
  {
    inputs: [],
    name: "converter",
    outputs: [{ internalType: "contract ITokenStandardConverter", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [],
    name: "erc223ReentrancyLock",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bool", name: "prefer223", type: "bool" },
      { internalType: "bytes", name: "data", type: "bytes" },
    ],
    name: "quoteSwap",
  ...
  {
    inputs: [
      { internalType: "address", name: "_t0erc223", type: "address" },
      { internalType: "address", name: "_t1erc223", type: "address" },
      { internalType: "address", name: "_library", type: "address" },
      { internalType: "address", name: "_quote_library", type: "address" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bool", name: "unwrapETH", type: "bool" },
    ],
    name: "swapExactInput",
