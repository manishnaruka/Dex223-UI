...
import { BigintIsh, MaxUint256, Rounding } from "@/sdk_bi/constants";
...
export class CurrencyAmount<T extends Currency> extends Fraction {
  ...
  protected constructor(currency: T, numerator: BigintIsh, denominator?: BigintIsh) {
    ...
    invariant(this.quotient <= MaxUint256, "AMOUNT"); // We now use BigInt comparisons directly
    this.currency = currency;
    this.decimalScale = BigInt(10) ** BigInt(currency.decimals); // Using BigInt for decimal scaling
  }
