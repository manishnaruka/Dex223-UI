...
export const FACTORY_ADDRESS: Record<DexChainId, Address> = {
  [DexChainId.MAINNET]: "0x3538fe2033c01c993c2021ffdad255d082f2da84",
...
export const ROUTER_ADDRESS: Record<DexChainId, Address> = {
  [DexChainId.MAINNET]: "0x35e23b4b13a3f1d9888a4a8a6aa5bc14d2d72a4a",
...
export const QUOTER_ADDRESS: Record<DexChainId, Address> = {
  [DexChainId.MAINNET]: "0x8e4b1eabb4e5bfd837a9a8118651adc76773c5b3",
...
export const NONFUNGIBLE_POSITION_MANAGER_ADDRESS: Record<DexChainId, Address> = {
  [DexChainId.MAINNET]: "0x6b25941517d31a79c727937ac6b7fcce65daf769",
...
export const POOL_INIT_CODE_HASH: Record<DexChainId, Address> = {
  [DexChainId.MAINNET]: "0x2e6dec004975848213cdcf9522f1cf0465e7862703f3a145d531f5cf24638d3c",
