...
export function useAllV3TicksQuery(
  baseOptions: Apollo.QueryHookOptions<AllV3TicksQuery, AllV3TicksQueryVariables>,
) {
...
export function useAllV3TicksLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<AllV3TicksQuery, AllV3TicksQueryVariables>(
    AllV3TicksDocument,
    options,
  );
}
...
export type FeeTierDistributionLazyQueryHookResult = ReturnType<
  typeof useFeeTierDistributionLazyQuery
>;
