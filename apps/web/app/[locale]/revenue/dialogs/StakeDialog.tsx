...
const StakeDialog = () => {
    ...
    const handleStakeUnstake = async () => {
        try {
            ...
            setData({ amount, selectedStandard: selectedStandard === Standard.ERC20 ? "ERC-20" : "ERC-223" });

            if (isStaking) {
                const currentBalance = selectedStandard === Standard.ERC20 ? redErc20Balance : redErc223Balance;
            ...
            addToast(
                `Successfully ${isStaking ? 'staked' : 'unstaked'} ${amount} D223`,
                "success"
            );
        } catch (error: any) {
                    ...
                    text={
                        <div className="flex items-start gap-2">
                            <span className="text-14">
                                You are not connected to Sepolia testnet. Please switch networks to see your balances and {isStaking ? 'stake' : 'unstake'}.
                            </span>
                        </div>
                    }
                />
            ...
            <div className="bg-secondary-bg rounded-3 p-5">
                <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-1">
                        <span className="text-14 text-secondary-text">{isStaking ? 'Stake' : 'Unstake'} amount</span>
                        <Tooltip
                            iconSize={16}
                ...
                <div className="gap-1 md:gap-3 relative md:pb-2 grid grid-cols-2">
                    <button
                        ...
                        className={clsx(
                            ...
                            selectedStandard === Standard.ERC20 ? "before:opacity-100" : "before:opacity-0 hocus:before:opacity-100"
                        )}
                    >
                        <div className="max-md:hidden flex items-center gap-1 cursor-default">
                            ...
                            <span className={clsx(
                                ...
                                selectedStandard === Standard.ERC20 ? "bg-green text-black" : "bg-tertiary-bg text-secondary-text"
                            )}>
                                {Standard.ERC20}
                            </span>
                        ...
                        <span className={clsx(
                            ...
                            <span className={selectedStandard === Standard.ERC20 ? "text-secondary-text" : "text-tertiary-text"}>
                                Balance
                            </span>{" "}
                    ...
                    <button
                        ...
                        className={clsx(
                            ...
                            selectedStandard === Standard.ERC223 ? "before:opacity-100" : "before:opacity-0 hocus:before:opacity-100"
                        )}
                    >
                        <div className="max-md:hidden flex items-center gap-1 cursor-default">
                            ...
                            <span className={clsx(
                                "px-2 py-0.5 rounded-2 text-10 font-medium",
                                selectedStandard === Standard.ERC223 ? "bg-green text-black" : "bg-tertiary-bg text-secondary-text"
                            )}>
                                {Standard.ERC223}
                            </span>
                            <span className={clsx(
                                "text-12",
                                selectedStandard === Standard.ERC223 ? "text-secondary-text" : "text-tertiary-text"
                            )}>
                                Standard
                            </span>
                        </div>
                        <span className={clsx(
                            ...
                            <span className={selectedStandard === Standard.ERC223 ? "text-secondary-text" : "text-tertiary-text"}>
                                Balance
                            </span>{" "}
    ...
    const renderApprovingState = () => (
        <div className="space-y-5">
            ...
            <div className="bg-tertiary-bg rounded-3 p-5">
                <div className="text-secondary-text text-14 mb-1">{isStaking ? 'Stake' : 'Unstake'} amount</div>
                <div className="flex items-center justify-between gap-3">
                    <div>
                        <div className="text-24 font-bold text-primary-text">
                            {amount || "0.00"}
                        </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col gap-1">
                            <span className="text-primary-text text-16 font-medium group-hover:text-green transition-colors duration-200">D223</span>
            ...
            <div className="space-y-3">
                ...
                <div className="flex items-center justify-between py-2 border-t border-secondary-border">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-primary-text text-14">Confirm {isStaking ? 'stake' : 'unstaking'}</span>
                    </div>
                    <div className="text-secondary-text text-12">
                        Proceed in your wallet
                    </div>
            ...
            <div className="space-y-3">
                ...
                <div className="flex items-center justify-between py-2 border-t border-secondary-border">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-primary-text text-14">Executing {isStaking ? 'staking' : 'unstaking'}</span>
                    </div>
                    <div className="flex items-center gap-2">
            ...
            <div className="space-y-3 border-t border-secondary-border pt-4">
                ...
                <div className="flex items-center justify-between py-2">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-primary-text text-14">Successfully {isStaking ? 'staked' : 'unstaked'}</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <Svg iconName="forward" size={20} className="text-secondary-text" />
                        <div className="w-6 h-6 bg-green rounded-full flex items-center justify-center">
            ...
            <div className="space-y-3 border-t border-secondary-border pt-4">
                ...
                <div className="flex items-center justify-between py-2">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-primary-text text-14">Failed to {isStaking ? 'stake' : 'unstake'}</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <Svg iconName="forward" size={20} className="text-secondary-text" />
