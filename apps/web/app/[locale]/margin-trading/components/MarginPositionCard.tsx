...
const balanceCardBorderMap: Record<DangerStatus, string> = {
  [DangerStatus.STABLE]: "before:bg-gradient-card-green-dark-border",
  [DangerStatus.RISKY]: "before:bg-gradient-card-yellow-light-border",
  [DangerStatus.DANGEROUS]: "before:bg-gradient-card-red-light-border",
};

const balanceCardBackgroundMap: Record<DangerStatus, string> = {
  [DangerStatus.STABLE]: "bg-gradient-card-green-light-fill",
  [DangerStatus.RISKY]: "bg-gradient-card-yellow-light-fill",
  [DangerStatus.DANGEROUS]: "bg-gradient-card-red-light-fill",
};
  ...
  return (
    <div
      className={clsx(
        ...
        balanceCardBorderMap[balanceStatus],
      )}
    >
      <div
        className={clsx(
          "pt-1.5 pb-0.5 px-5 relative rounded-3",
          balanceCardBackgroundMap[balanceStatus],
        )}
      >
