    ...
    <Link
      className={clsx(
        ...
        active
          ...
          : "hover:bg-navigation-hover hover:text-green hover:shadow-green/60 hover:text-shadow",
    ...
    <Popover
      ...
      trigger={
        ...
        >
          ...
          <Svg
            className={clsx(
              "group-hover:drop-shadow-[0_0_2px_var(--tw-shadow-color)] group-hover:shadow-green/60",
