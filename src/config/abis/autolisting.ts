export const NONPAYABLE_AUTOLISTING_ABI = [
  {
    inputs: [
...
export const PAYABLE_AUTOLISTING_ABI = [
  {
    inputs: [
      { internalType: "address", name: "_factory", type: "address" },
      { internalType: "address", name: "_registry", type: "address" },
    ...
    outputs: [
      {
        ...
        internalType: "struct Dex223AutoListing.TokenPrice[]",
        name: "",
        type: "tuple[]",
      },
    ],
  ...
  {
    inputs: [{ internalType: "string", name: "_newURL", type: "string" }],
    name: "updateMe",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
